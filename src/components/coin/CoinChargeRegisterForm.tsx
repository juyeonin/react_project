        ...
        <div className={styles.centered}>
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3 row">
                    <label><strong>충전금액</strong></label>
                ...
                <div className={styles.align_center} style={{marginBottom:"50px"}}>
                    <button className="btn btn-dark btn-sm" type="submit">충전하기</button>
                    <Link className="btn btn-light btn-sm" to="/coin/charge">충전내역</Link>
                </div>
            </form>
        </div>
    );
