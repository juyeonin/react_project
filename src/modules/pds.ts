...
const pdsSlice = createSlice({
  ...
  initialState,
  reducers: {
    addAttach(state, { payload: attach }) {
    ...
    removeAttach(state, { payload: index }) {
...
export default pdsSlice;

export const pdsActions = {
  fetchPdsList,
  fetchPdsOne,
  add: pdsSlice.actions.addAttach,
  remove: pdsSlice.actions.removeAttach,
  attachList: pdsSlice.actions.fetchAttachList,
  reset: pdsSlice.actions.resetAttach
